...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initFuncionamento)\n/* harmony export */ });\nfunction initFuncionamento() {\n  var funcionamento = document.querySelector(\"[data-semana]\");\n  var diasSemana = funcionamento.dataset.semana.split(\",\").map(Number); // pega os valores dos dias de data-semana e transforma em array de números\tusando os métodos split e map. Map recebeu o objeto Construtor Number.\n  var horarioSemana = funcionamento.dataset.horario.split(\",\").map(Number);\n  var dataAgora = new Date(); // cria um novo objeto Date com a data atual\n  var diaAgora = dataAgora.getDay(); // pega o dia atual da semana (0-6)\n  var horarioAgora = dataAgora.getHours(); // pega a hora atual (0-23)\n\n  var semanaAberto = diasSemana.indexOf(diaAgora) !== -1; // verifica se o dia atual está no array de dias da semana\n\n  var horarioAberto = horarioAgora >= horarioSemana[0] && horarioAgora < horarioSemana[1]; // verifica se a hora atual está dentro do intervalo de horário\n\n  if (semanaAberto && horarioAberto) {\n    // verifica se estamos abertos\n    funcionamento.classList.add(\"aberto\");\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/funcionamento.js?\n}");
